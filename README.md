...
Recommended helpers:
  ...
  * [git initer](doc/git-initer/index.md) - Init a repo using our recommended way i.e. with an empty rebaseable commit
  * [git cloner](doc/git-cloner/index.md) - Clone a repo using our recommended way i.e. recurse on all submodules
...
Starting:
  ...
  * [git initer](doc/git-init-empty/index.md) - Initialize a repo our way
  * [git init-empty](doc/git-init-empty/index.md) - Initialize a repo with an empty rebaseable commit
  * [git cloner](doc/git-cloner/index.md) - Clone a repo and recurse on any of its submodules
...
## Index of all aliases
  ...
  * [git initer](doc/git-initer/index.md) - Initalize a repo our team's way (default is "init-empty")
